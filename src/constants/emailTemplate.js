export const TEMPLATE_BY_EMAIL_TYPE = {
  ...
  invoice_generated: "invoice_email",
};
...
<div class="card">
  ...
  confirmation_email: `<!DOCTYPE html>
    ...
    <style>
      ...
      .items-table th, .items-table td { padding: 8px 10px; font-size: 12.5px; text-align: left; border-bottom: 1px solid #e2e8f0; }
      .items-table th { background: #f1f5f9; color: #475569; text-transform: uppercase; font-size: 10.5px; letter-spacing: 0.4px; }
      ...
      @media (max-width: 640px) {
        ...
        .footer { padding: 24px 20px; }
        .header-title { font-size: 20px; }
        .items-table th, .items-table td { padding: 6px; font-size: 11px; }
      }
    </style>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    </head>
    ...
    <div class="card">
      <div class="header">
        ...
        <p class="header-subtitle">Your booking details have been recorded and are ready for your review.</p>
      </div>
      <div class="content">
        <p class="greeting">Dear {{recipientName}},</p>
        <p class="body-text">Please find your booking confirmation details below from {{senderName}} at {{companyName}}.</p>
        <div class="btn-wrapper">
      ...
      <div class="footer">
        <img src="{{companyLogo}}" alt="{{companyName}}" class="footer-logo">
        <div class="footer-text">
          {{companyName}}<br>
          This document was sent by {{senderName}}. If the button above doesn't work, contact us directly.
        </div>
        <div class="footer-divider"></div>
        <div class="footer-copyright">
      ...
      <div class="content">
        ...
        <div class="info-box">
          ...
          <table class="info-table" role="presentation">
            ...
            <tr><td>Issue Date</td><td>{{lastUpdated}}</td></tr>
          </table>
        </div>
        <div class="security-notice">
