          ...
          <Modal open={openHistoryModal} onClose={() => setOpenHistoryModal(false)}>
            <Box sx={{ ...modalStyle, width: { xs: '90%', sm: 1400 }, maxHeight: '90vh', overflowY: 'auto' }}>
              <Box sx={{
                ...
                alignItems: { xs: 'flex-start', sm: 'center' }, // Mobile: start, Desktop: center
                gap: 2, // Add gap for spacing in column layout
                mb: 2
              }}>
                <Typography
                  variant="h5"
                ...
                <Button
                  ...
                  sx={{
                    ...
                    borderColor: "#f58220",
                    color: "#f58220",
                    alignSelf: { xs: 'flex-start', sm: 'center' } // Align button
                  }}
                >
                  {generatingPDF ? 'Generating PDF...' : 'Print Manifest'}
                </Button>
              </Box>
              <Divider sx={{ mb: 3 }} />
              {loadingHistory ? (
