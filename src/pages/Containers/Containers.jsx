...
const ContainerModule = ({
  ...
  const fetchOptions = async () => {
    ...
    try {
      const [statusRes, locationRes, sizeRes, typeRes, ownershipRes] =
        await Promise.all([
  ...
  const validateForm = () => {
    ...
    if (formData.ownership === "coc") {
      ...
      if (
        !formData.freeDays ||
        !validateNumber(formData.freeDays, "Free Days")
      ) {
    ...
    <Box sx={{ p: 3, borderRadius: 3, boxShadow: 3, bgcolor: "#fafafa" }}>
      ...
      >
            ...
            >
              ...
              >
                ...
                {ownershipTypes.map((own) => (
                  <MenuItem key={own.value} value={own.value}>
                    {own.label}
                  </MenuItem>
                ))}
              </Select>
                      ...
                      usageHistory.map((history, index) => (
                        ...
                        >
                          <TableCell
                            ...
                            onClick={() =>
                              alert(`Go to Job ${history.jobNo || "N/A"}`)
                            }
                          >
                            {history.jobNo || "N/A"}
                          </TableCell>
        ...
        <Backdrop
          ...
          open={
            loadingForm || loadingOptions || loadingHistory || loadingUpdate
          }
        >
