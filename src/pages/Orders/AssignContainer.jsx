...
//  const isEditingAssign = editingAssignReceiverId === rec.id; 
                                        ...
                                        const delivered = parseInt(fullRec.qtyDelivered || rec.qtyDelivered || fullRec.qty_delivered || rec.qty_delivered || '0') || 0;
                                                ...
                                                {isExpanded && shippingDetails.length > 1 && shippingDetails.map((detail, idx) => {
                                                    ...
                                                    return (
                                                        <TableRow 
                                                            ...
                                                            role="row"
                                                        >
                                                            <TableCell colSpan={12} sx={{ p: 3, borderTop: `2px solid ${themeColors.border}` }}>
                                                                <Stack direction={{ xs: 'column', md: 'row' }} gap={2.5} alignItems={{ xs: 'stretch', md: 'center' }} justifyContent="space-between">
                                                                    <Box sx={{ flex: 1 }}>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            Delivered: <strong style={{ color: themeColors.textPrimary }}>{detailDelivered}</strong> pcs | 
