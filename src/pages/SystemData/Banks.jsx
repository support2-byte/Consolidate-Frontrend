      ...
      <Paper sx={{ p: 2, overflowX: "auto", position: "relative" }}>
        ...
        {error && !loading && (
          <Alert severity="error" sx={{ mb: 2 }}>
            {error}.{" "}
            <Button size="small" onClick={fetchBanks}>
              Retry
            </Button>
          </Alert>
        )}
        ...
        <DialogContent dividers>
          <Typography variant="body2" color="textSecondary" sx={{ mb: 2 }}>
            {editMode
              ...
              : "Enter bank details. Required fields are marked with *."}
          </Typography>
          <TextField
            fullWidth
            label="Bank Name *"
          ...
          <TextField
            ...
            helperText={
              !formData.swift_code.trim()
                ? "Required field (e.g., BOFAUS3N)"
                : ""
            }
          />
          <TextField
