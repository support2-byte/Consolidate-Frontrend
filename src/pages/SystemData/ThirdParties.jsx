...
const ThirdParties = () => {
  ...
  const handleDelete = async (id) => {
    if (
      !window.confirm(
        "Are you sure you want to delete this third party? This action cannot be undone.",
      )
    ) {
      return;
    }
        ...
        <Table>
          <TableHead sx={{ background: "#0d6c6a", color: "#fff" }}>
            <TableRow>
              ...
              <TableCell sx={{ background: "#0d6c6a", color: "#fff" }}>
        ...
        <DialogContent dividers>
          <Typography variant="body2" color="textSecondary" sx={{ mb: 2 }}>
            {editMode
              ...
              : "Enter third party details. Required fields are marked with *."}
          </Typography>
          <TextField
            fullWidth
            label="Company Name *"
          ...
          <TextField
            ...
            helperText={
              !formData.address.trim()
                ? "Required field (include plot, street, city, etc.)"
                : ""
            }
          />
